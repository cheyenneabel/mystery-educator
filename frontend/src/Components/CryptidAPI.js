...
//     useEffect(() => {
//         // fetching a random Cryptid
//         fetch('http://localhost:8080/random/cryptid')
//         .then((response) => response.json())
//         .then((json) => setRandomCreature(json))

//         fetch('http://localhost:8080/cryptid')
//         .then((response) => response.json())
//         .then((json) => setAllCreatures(json))
//     }, [])
...
//     function handleRandomCryptid(e){
//         e.preventDefault();
...
//                     <div>
//                         <h2>{randomCreature.name}</h2>
//                         <p>{randomCreature.description}</p>
//                     </div> 
//                 )
//             )
//         }
...
//     return(
//         <div>
//             <button id="randomCryptid" onClick={handleRandomCryptid}> Random Cryptid </button>
//             {
