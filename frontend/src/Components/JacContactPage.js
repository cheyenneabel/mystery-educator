      ...
      <main id="main">
          ...
          <section id="section-b" class="grid">
              <ul>
                  <li>
                      <div class="card">
                          <img src="./assets/images/redsea-1-1024x768.jpg" alt=""></img>
                  ...
                  <li>
                      <div class="card">
                          <img src="./assets/images/cavern.jpg" alt="" srcset=""></img>
                          <div class="card-content">
                  ...
                  <li>
                      <div class="card">
                          <img src="./assets/images/trek-to-k2-2.jpg" alt="" srcset=""></img>
                          <div class="card-content">
                  ...
                  <li>
                      <div class="card">
                          <img src="./assets/images/toucan-barbet.jpg" alt="" srcset=""></img>
                          <div class="card-content">
